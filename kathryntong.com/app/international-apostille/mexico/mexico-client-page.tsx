    ...
    <div className="min-h-screen bg-white text-foreground">
      ...
      <main className="py-6 md:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-6">
            <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-4">
              <p className="text-foreground text-base leading-relaxed">
                Mexico is a Hague Apostille Convention member, making apostille processing straightforward.
              </p>
            </div>
          </div>

          {/* Mexico Apostille Overview Section */}
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-foreground mb-3">
              Mexico Apostille Overview
            </h2>
            <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-4">
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-foreground mb-3">
              Common Documents Used in Mexico
            </h2>
            <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-4">
              <ul className="space-y-1.5">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 font-bold">•</span>
                  <span className="text-foreground text-base">Immigration and dual-citizenship documents</span>
                </li>
              </ul>
            </div>
          </div>

          {/* Mail-In Eligibility Section */}
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-foreground mb-3">
              Mail-In Eligibility
            </h2>
            <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-4">
              <p className="text-foreground text-base leading-relaxed mb-3">
                Most Mexico-bound documents qualify for mail-in apostille service.
              </p>
