...
export default function SaudiArabiaApostilleClientPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-6">
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-3">
              Saudi Arabia Apostille Services – U.S. Document Apostille for Use in Saudi Arabia
            </h1>
          </div>
          ...
          <div className="mb-6">
            <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-4">
              <p className="text-foreground text-base leading-relaxed mb-3">
                Saudi Arabia is a member of the Hague Apostille Convention and accepts Hague Apostilles for qualifying U.S. documents. A Hague Apostille certifies the authenticity of a document so it can be recognized by authorities in Saudi Arabia without additional embassy or consular legalization.
              </p>
              <p className="text-foreground text-base leading-relaxed">
                Kathryn's Mobile Notary & Apostille assists clients with preparing U.S. documents for use in Saudi Arabia by ensuring the correct apostille process is applied based on document type and issuing authority.
              </p>
            </div>
          </div>

          {/* Common Documents Used in Saudi Arabia Section */}
          <div className="mb-6">
            ...
            <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-4">
              <ul className="space-y-1.5">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 font-bold">•</span>
                  <span className="text-foreground text-base">Corporate and commercial documents</span>
                </li>
              </ul>
            </div>
          </div>

          {/* Important Notes for Saudi Arabia Section */}
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-foreground mb-3">
              Important Notes for Saudi Arabia
            </h2>
            <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-4">
              <ul className="space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 font-bold">•</span>
                  <span className="text-foreground text-base">Documents must be apostilled by the appropriate U.S. authority</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 font-bold">•</span>
                  <span className="text-foreground text-base">Some receiving institutions may require Arabic translations</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 font-bold">•</span>
                  <span className="text-foreground text-base">Final acceptance is determined by the Saudi receiving authority</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-foreground mb-3">
              Frequently Asked Questions – Saudi Arabia Apostille
            </h2>
            <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-4 space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">
                  Q: Does Saudi Arabia accept Hague Apostilles?
                </h3>
                <p className="text-foreground text-base leading-relaxed">
                  A: Yes. Saudi Arabia is a Hague Apostille Convention member and accepts properly issued Hague Apostilles.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">
                  Q: Is embassy legalization required after an apostille?
                </h3>
                <p className="text-foreground text-base leading-relaxed">
                  A: No. Embassy or consular legalization is not required once a valid Hague Apostille is attached.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">
                  Q: Do documents need to be translated into Arabic?
                </h3>
                <p className="text-foreground text-base leading-relaxed">
                  A: Some Saudi institutions require certified Arabic translations depending on document type and purpose.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">
                  Q: Can I mail my documents from outside California?
                </h3>
                <p className="text-foreground text-base leading-relaxed">
                  A: Yes. Mail-in apostille service is available nationwide.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">
          ...
          <div className="mb-6">
            <div className="bg-primary/10 border border-primary/30 rounded-lg p-4">
              <p className="text-foreground text-sm italic text-foreground/80">
                This page is provided in English. Certified Arabic translations may be required by authorities in Saudi Arabia. Acceptance is determined by the receiving institution.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            <div className="bg-primary/10 border border-primary/30 rounded-lg p-4">
              ...
              <p className="text-foreground text-base mb-2">
                Contact us today for expert Saudi Arabia apostille services.
              </p>
