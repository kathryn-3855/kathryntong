    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="min-h-screen bg-background">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {/* Who I Serve Section */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-6">Who I Serve</h2>
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-6">Why Clients Choose Kathryn's Mobile Notary & Apostille</h2>
            <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-6">
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1 font-bold">•</span>
              ...
              <p className="text-base text-foreground mt-4 italic">
          ...
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-6">Languages & International Clients</h2>
            <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-6">
              <p className="text-base text-foreground leading-relaxed">
