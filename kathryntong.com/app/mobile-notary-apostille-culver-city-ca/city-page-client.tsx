            ...
            <div className="grid md:grid-cols-2 gap-6 items-start">
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                  Culver City Mobile Notary & Apostille Services
                </h1>
                
                <div className="space-y-3 mb-4">
                  <p className="text-foreground text-base leading-relaxed">
                    Kathryn's Mobile Notary & Apostille serves Culver City and surrounding neighborhoods with mobile and mail-in apostille services for personal and business documents.
                  </p>
                </div>
                  ...
                  <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-5">
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                        ...
                        <span className="text-foreground text-base">Culver City downtown</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                        <span className="text-foreground text-base">Playa Vista (nearby)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                        <span className="text-foreground text-base">West Culver City</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                        <span className="text-foreground text-base">Sony Studios / Media District</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="relative h-80 rounded-lg overflow-hidden">
                <Image
                  src="/images/cities/culver-city.jpg"
                  alt="Culver City with mobile notary services"
                  fill
