...
export const metadata: Metadata = {
  title: "San Marino Mobile Notary & Apostille Services",
  description:
    "Mobile notary and apostille services in San Marino. Reliable service for notarization and international document processing.",
  ...
  openGraph: {
    title: "San Marino Mobile Notary & Apostille Services",
    description: "Mobile notary and apostille services in San Marino. Reliable service for notarization and international document processing.",
    type: "website",
    locale: "en_US",
