            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                  San Marino Mobile Notary & Apostille Services
                </h1>
                
                <div className="space-y-4 mb-6">
                  <p className="text-foreground text-base leading-relaxed">
                    Kathryn's Mobile Notary & Apostille serves San Marino residents and businesses with full mobile notary and apostille services.
                  </p>
                </div>
                  ...
                  <div className="bg-foreground/10 border border-foreground/30 rounded-lg p-6">
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                        ...
                        <span className="text-foreground text-base">San Marino Highlands</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                        <span className="text-foreground text-base">Lacy Park area</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                        <span className="text-foreground text-base">Huntington Drive corridor</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="relative h-96 rounded-lg overflow-hidden">
                <Image
                  src="/images/cities/san-marino.jpg"
                  alt="San Marino with mobile notary services"
                  fill
